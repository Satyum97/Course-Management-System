	          ...
	          <div class="page-content" style="height: 100%; position: relative;"><!-- Your content goes here -->
	            <div class = "bg" style="height: 100%;">
	              <div class = "signup-form">
	                <div class = "signup-title gotu">Sign Up</div>
	                <form action="#" class = " gotu form">
	                  ...
	                  <div style="width: 100%;padding:20px 0;">
	                    <span style = "width: 25%;font-size:16px;float: left;">Gender:</span>
	                  ...
	                  <div hidden="true" style="width: 100%;padding:20px 0;">
	                    ...
	                    <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="student" style = "width:22%">
	                      <input type="radio" id="student" class="mdl-radio__button" name="role" value="student" checked>
	                  ...
	                  <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" id = "submit" style="width: 100%;" disabled>
	                    Sign Up
	                  </button>
